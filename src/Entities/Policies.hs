module Entities.Policies (Policy(..), getActivePolicy, updatePolicy, addNewPolicy, getPoliciesByCertificate, policyStatusRuTranslate, policyStatusEngTranslate) where
